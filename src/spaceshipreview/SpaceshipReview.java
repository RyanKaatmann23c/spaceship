...
//Variables for stars.
    ...
    int starXPos[];
    int starYPos[];
    int StarValue[] = new int[numStars];
    int whichStarHit;
...
//Display the stars.
        ...
        {
            drawCircle(StarImage,getX(starXPos[i]),getYNormal(starYPos[i]),
                0.0,1.8,1.8 );
        }
//Display the missiles.
        ...
        for (int i=0;i<missiles.length;i++)
        {
            if (missiles[i].active)
                drawCircle2(MissilLOL1,getX(missiles[i].xpos),getYNormal(missiles[i].ypos),
                0.0,0.3,0.3 );
        }        
//Display the rocket.
        if (rocketRight)
...
//Display the high score.
        g.setColor(Color.cyan);
        g.setFont(new Font("Impact",Font.ITALIC,20));
        g.drawString("High Score: " + highScore, 280, 45); 
        ...
        g.setColor(Color.cyan);
        g.setFont(new Font("Impact",Font.ITALIC,20));
        g.drawString("Lives: " + Lives, 150, 45); 
        
        gOld.drawImage(image, 0, 0, null);
    }
////////////////////////////////////////////////////////////////////////////
    public void drawCircle(Image image,int xpos,int ypos,double rot,double xscale,double yscale)
    {
        g.translate(xpos,ypos);
        g.rotate(rot  * Math.PI/180.0);
        g.scale( xscale , yscale );
        int width = MissilLOL1.getWidth(this);
        int height = MissilLOL1.getHeight(this);
    ...
    ////////////////////////////////////////////////////////////////////////////
    public void drawCircle2(Image image,int xpos,int ypos,double rot,double xscale,double yscale)
    {
        g.translate(xpos,ypos);
        g.rotate(rot  * Math.PI/180.0);
        g.scale( xscale , yscale );
...
/////////////////////////////////////////////////////////////////////////
    public void animate() {
        if (animateFirstTime) {
            ...
            MissilLOL1 = Toolkit.getDefaultToolkit().getImage("./Missile.GIF");
            reset();
...
//Class variables.
    ...
    public static int numMissiles = 100;     
//Instance variables.
    public int xpos;
    public int ypos;
